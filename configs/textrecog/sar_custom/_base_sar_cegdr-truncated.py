_base_ = [
    'mmocr::textrecog/sar/sar_resnet31_parallel-decoder_5e_st-sub_mj-sub_sa_real.py',
...
work_dir = 'work_dirs/sar_custom_cegdr-truncated' 
...
auto_scale_lr = dict(base_batch_size=192 * 48) 
...
default_hooks = dict(
    checkpoint=dict(
        type='CheckpointHook',
        interval=1,
        save_best='test/word_acc',  # same key as above
        rule='greater'
    )
) 